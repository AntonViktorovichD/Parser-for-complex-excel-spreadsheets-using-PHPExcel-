Joomla = window.Joomla || {}, Joomla.editors = Joomla.editors || {}, Joomla.editors.instances = Joomla.editors.instances || {}, function (a, b) {
    "use strict";
    a.submitform = function (a, c, d) {
        ...
        var b = /^[\w.!#$%&вЂљГ„Гґ*+\/=?^`{|}~-]+@[a-z0-9-]+(?:\.[a-z0-9-]{2,})+$/i;
        return b.test(a)
        ...
        if ("undefined" == typeof c && (c = b.getElementById("adminForm")), c.boxchecked.value = a ? parseInt(c.boxchecked.value) + 1 : parseInt(c.boxchecked.value) - 1, c.elements["checkall-toggle"]) {
            var e, f, g, d = !0;
            for (e = 0, g = c.elements.length; e < g; e++) if (f = c.elements[e], "checkbox" == f.type && "checkall-toggle" != f.name && !f.checked) {
                d = !1;
                break
            }
        ...
        var k, l, m, h = "<select " + a + ">", i = d == e, j = 0;
        ...
        if (c = c || "show", d = d || b.body, "load" == c) {
            var e = b.getElementsByTagName("body")[0].getAttribute("data-basepath") || "", f = b.createElement("div");
