    ...
    return function (t) {
        ...
        class sh extends rh {
            ...
            init() {
                ...
                e.editable.bind("isReadOnly").to(n), e.editable.bind("isFocused").to(t.editing.view.document), e.editable.name = n.rootName, this.focusTracker.add(this.view.editableElement), this.view.toolbar.fillFromConfig(this._toolbarConfig.items, this.componentFactory), function ({
                                                                                                                                                                                                                                                                                                 origin: t,
        ...
        class ff {
            ...
            _handleTextMutation(t, e) {
                ...
                const n = t.newText.replace(/\u00A0/g, " "), o = Ti(t.oldText.replace(/\u00A0/g, " "), n), {
                    firstChangeAt: i,
                    insertions: r,
                    deletions: s
                } = mf(o);
