...
(function () {
    var b = this.document, a = b.window = this, c = navigator.userAgent.toLowerCase(),
...
(function () {
    ...
    var a = b.style.opacity != null, d = b.style.filter != null, e = /alpha\(opacity=([\d.]+)\)/i,
        f = a ? function (a, b) {
            a.style.opacity = b
        } : d ? function (a, b) {
            var c = a.style;
        ...
        return {
            base: "focusin", remove: function (b, c) {
                ...
                if (f = g.get("tag") == "form" ? g : f.target.getParent("form")) {
                    var r = b.retrieve("$delegation:" + a + "listeners", {}), w = r[i] || {forms: [], fns: []},
                        l = w.forms, s = w.fns;
                    if (l.indexOf(f) == -1) {
                        l.push(f);
                        l = function (a) {
    ...
    Element.implement({
        scrollTo: function (a, b) {
            ...
            if (this.getBoundingClientRect &&
                ...
                var e = this.getBoundingClientRect(), f = document.id(this.getDocument().documentElement),
                    g = f.getScroll(), i = this.getScrolls(), j = h(this, "position") == "fixed";
                return {
...
(function () {
    var b = function () {
        ...
        send: function (b) {
            ...
            var c = this.options, b = Object.append({data: c.data, url: c.url, method: c.method}, b), c = b.data,
                d = "" + b.url, b = b.method.toLowerCase();
            switch (typeOf(c)) {
                case "element":
