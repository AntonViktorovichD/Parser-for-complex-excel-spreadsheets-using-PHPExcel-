...
class WeeklyReportController extends Controller {
    public function weekly_report($table_uuid) {
        ...
        if (count($weekly_reports) > 0) {
            ...
            return view('weekly_report', compact('json', 'json_vals', 'json_func', 'highest_row', 'highest_column_index', 'addRowArr', 'name', 'row_uuid', 'table_uuid', 'pattern', 'read_only', 'department'));
        } else {
            return view('weekly_report', compact('json', 'json_func', 'highest_row', 'highest_column_index', 'addRowArr', 'name', 'row_uuid', 'table_uuid', 'pattern', 'read_only', 'department'));
        }
    }
