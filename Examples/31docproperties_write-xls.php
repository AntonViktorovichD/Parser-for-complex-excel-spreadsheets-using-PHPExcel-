...
$objPHPExcel->getProperties()->setTitle("Office 95 XLS TestController Document")
							 ->setSubject("Office 95 XLS TestController Document")
							 ->setDescription("TestController XLS document, generated using PHPExcel")
