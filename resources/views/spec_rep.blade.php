...
@php
    $rowSpan = $highest_row - 1;
    $table = [];
    echo '<h5 class="text-center text-wrap" style="margin-top: 180px;"> Отчет об осуществлении выплат стимулирующего характера за особые условия труда и дополнительную нагрузку работникам стационарных организаций социального обслуживания, стационарных отделений, созданных не в стационарных организациях социального обслуживания </h5>';
    echo '<h6 class="text-center text-wrap" style="margin-top: 30px;">Таблица 1 (размеры выплат в случае невыявленния новой коронавирусной инфекции) </h5>';
    echo '<h5 class="text-center text-wrap" style="color: red; margin: 30px 0;"> данные вносятся с нарастающим итогом </h5>';
    echo '<table>' . PHP_EOL;
    echo '<tr>';
 ...
 $qw = 0;
    ...
    $table_info = $name . ' + 09fdb928-b36a-4c5b-8979-8c5e9a62fe63 + ' . $row_uuid . ' + ' . $user_id . ' + ' . $department;
    echo '<input type="hidden" name="table_information" value="' . $table_info . '"';
    echo '</tr>' . PHP_EOL;
    echo '</table>' . PHP_EOL;
    if ($read_only == 'disabled') {
